...
const sf::Time BALL_SPAWN_COOLDOWN_DURATION = sf::seconds(2.f); // sec
...
const std::string MUSIC_FILENAME = "bounce_music.mp3";
const std::string BOUNCE_SOUND_FILENAME = "bounce_sound.mp3";
const std::string BACKGROUND_TEXTURE_FILENAME = "bounce_background.jpg";
